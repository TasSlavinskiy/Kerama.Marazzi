...
function validationBasket(form){
...
$(document).ready(function(){
   ...
   validate('.vhod', {submitFunction:validationCall});
   validate('.regist', {submitFunction:validationCall});
   validate('.text-form', {submitFunction:validationCall});
   // validate('.basket-form', {submitFunction:validationBasket});
